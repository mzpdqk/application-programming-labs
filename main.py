...
def save_ann(img_paths: List[str], ann_file: str):
    """записываем аннотации в csv файл"""
    with open(ann_file, mode='w', newline='', encoding='utf-8') as f:  # добавлено encoding='utf-8'
        writer = csv.writer(f)
...
class ImgLoader:
    ...
    def load_ann(self):
        ...
        with open(self.ann_file, mode='r', encoding='utf-8') as f:  # добавлено encoding='utf-8'
            reader = csv.reader(f)
...
def main():
    ...
    img_paths = fetch_imgs(args.term, args.folder)  # порядок ввода в консоль: "keyword  папка  аннотация.csv"
